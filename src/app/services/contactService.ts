...
export class ContactService {
  ...
  //mock the server
  private _contactsDb: Contact[] = JSON.parse(localStorage.getItem('contacts')) || CONTACTS ;
  ...
  public loadContacts(filterBy = null): void {
    ...
    _saveToStorage(this._contactsDb)
  ...
  private _addContact(contact: Contact) {
    //mock the server work
    const newContact = new Contact(utilService.makeId(), contact.name, contact.email, contact.phone);
    // newContact.setId();
...
function _saveToStorage(contacts) {
